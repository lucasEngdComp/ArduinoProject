...
// down 
const int echoPin2= 53; //yellow wire
const int trigPin2= 52; // orange wire
...
float measure_1 (void) {
    ...
    if (distancia > 30) distancia=31;
    else if (distancia < 0) distancia=0;
    
    return 0.01*(distancia-1.5+0.5+2);   // meters   
...
float measure_2 (void) {
    ...
    return 0.01*(distancia+2);   // meters     ( +2 to measure the center of the cube )
